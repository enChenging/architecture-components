...
class DebugLoginActivity : BaseActivity<DebugActivityLoginBinding, DebugLoginViewModel>() {
    ...
    var mCurRouteUrl = RouteUrl.Example.ExampleHomeActivity
            ...
            mPermissionRequest.permissionRequest(this, {
                ...
                when {
                    packageName.contains(".example") -> {
                        mCurRouteUrl = RouteUrl.Example.ExampleHomeActivity
                    }
                    packageName.contains(".example2") -> {
                        mCurRouteUrl = RouteUrl.Example2.Example2HomeActivity
                    }
                }
