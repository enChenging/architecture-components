...
import com.release.architecture.common.databinding.CommonDialogConfirmBinding
import com.release.architecture.common.databinding.CommonDialogConfirmCancelBinding
import com.release.architecture.common.databinding.CommonDialogConfirmCancelNoTitleBinding
import com.release.architecture.common.databinding.CommonDialogTipsBinding
...
class DialogFactory {
    ...
    companion object {
        ...
        inline fun createTipsDialog(
            ...
            CommonDialogTipsBinding.inflate(dialog.layoutInflater).apply {
        ...
        inline fun createConfirmCancelDialog(
            ...
            val dialog = Dialog(context, R.style.common_transparent_dialog)
            dialog.setCanceledOnTouchOutside(canceledOnTouchOutside)
            CommonDialogConfirmCancelBinding.inflate(dialog.layoutInflater).apply {
                vTitleTv.text = titleText
                vContentTv.text = content
        ...
        inline fun createConfirmDialog(
            ...
            val dialog = Dialog(context, R.style.common_transparent_dialog)
            dialog.setCanceledOnTouchOutside(canceledOnTouchOutside)
            CommonDialogConfirmBinding.inflate(dialog.layoutInflater).apply {
                vTitleTv.text = titleText
                vContentTv.text = content
                vConfirmTv.text = confirmText
                vConfirmTv.setOnClickListener {
        ...
        inline fun createConfirmCancelNoTitleDialog(
            ...
            val dialog = Dialog(context, R.style.common_transparent_dialog)
            dialog.setCanceledOnTouchOutside(canceledOnTouchOutside)
            CommonDialogConfirmCancelNoTitleBinding.inflate(dialog.layoutInflater).apply {
                vContentTv.text = content
                vCancelTv.text = cancelText
                vConfirmTv.text = confirmText
                vConfirmTv.setOnClickListener {
